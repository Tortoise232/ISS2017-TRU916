...
@Component({
  moduleId: module.id,
  selector: 'paper-list-for-user',
  templateUrl: './paper-list-for-user.component.html',
  styleUrls: ['./paper-list-for-user.component.css'],

})

export class ListPaperUserComponent implements  OnInit{
  papers: Paper[];
  ...
  listAllForUser(){
    this.paperService.findAllForUser(this.currentUser).subscribe(papers=>this.papers=papers);
  }
